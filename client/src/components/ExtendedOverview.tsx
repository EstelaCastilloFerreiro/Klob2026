...
export default function ExtendedOverview() {
  ...
  if (!fileId) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <p className="text-lg text-muted-foreground">{t.app.analytics.sections.uploadFilePrompt}</p>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <Card className="p-6 max-w-md">
          <p className="text-destructive font-medium mb-2">{t.app.analytics.messages.errorLoading}</p>
          <p className="text-sm text-muted-foreground">
            {error instanceof Error ? error.message : t.app.analytics.messages.unknownError}
          </p>
        </Card>
      </div>
    );
  ...
  if (!data) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <p className="text-lg text-muted-foreground">{t.app.analytics.messages.noData}</p>
      </div>
    );
  }
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
      ...
      <VisualizationCard 
        title={`${t.app.analytics.sections.analysisScope} ${t.app.analytics.sections.excludingFictitious}`}
        id="alcance"
      >
        <div className="grid grid-cols-2 gap-3">
          <div className="text-center p-3 border rounded-md bg-card">
            <p className="text-xs text-muted-foreground mb-1">{t.app.analytics.kpis.totalFamilies}</p>
            <p className="text-xl font-bold font-mono" data-testid="text-total-familias">
              {data.alcance.totalFamilias}
            </p>
          </div>
          <div className="text-center p-3 border rounded-md bg-card">
            <p className="text-xs text-muted-foreground mb-1">{t.app.analytics.kpis.totalStores}</p>
            <p className="text-xl font-bold font-mono" data-testid="text-total-tiendas">
              {data.alcance.totalTiendas}
            </p>
          </div>
          <div className="text-center p-3 border rounded-md bg-card">
            <p className="text-xs text-muted-foreground mb-1">{t.app.analytics.kpis.totalSeasons}</p>
            <p className="text-xl font-bold font-mono" data-testid="text-total-temporadas">
              {data.alcance.totalTemporadas}
            </p>
          </div>
          <div className="text-center p-3 border rounded-md bg-card">
            <p className="text-xs text-muted-foreground mb-1">{t.app.analytics.kpis.transactions}</p>
      ...
      {/* KPIs Generales */}
      <VisualizationCard 
        title={`${t.app.analytics.sections.generalKPIs} ${t.app.analytics.sections.excludingFictitious}`}
        id="kpis-generales"
      >
        <div className="grid grid-cols-2 gap-3">
          <div className="text-center p-3 border rounded-md bg-card">
            <p className="text-xs text-muted-foreground mb-1">{t.app.analytics.kpis.grossSales}</p>
          ...
          <div className="text-center p-3 border rounded-md bg-card">
            <p className="text-xs text-muted-foreground mb-1">{t.app.analytics.kpis.returns}</p>
          ...
          <div className="text-center p-3 border rounded-md bg-card">
            <p className="text-xs text-muted-foreground mb-1">{t.app.analytics.kpis.netTotal}</p>
          ...
          <div className="text-center p-3 border rounded-md bg-card">
            <p className="text-xs text-muted-foreground mb-1">{t.app.analytics.kpis.returnRate}</p>
      ...
      <VisualizationCard 
        title={t.app.analytics.sections.fictitiousKPIs}
        id="kpis-ficticio"
      >
        <div className="grid grid-cols-2 gap-3">
          <div className="text-center p-3 border rounded-md bg-card">
      ...
      <VisualizationCard 
        title={`${t.app.analytics.sections.storeTypeKPIs} ${t.app.analytics.sections.excludingFictitious}`}
        id="kpis-tienda"
      >
        <div className="grid grid-cols-2 gap-3">
          <div className="text-center p-3 border rounded-md bg-card">
            <p className="text-xs text-muted-foreground mb-1">{t.app.analytics.kpis.physicalStores}</p>
            <p className="text-xl font-bold font-mono" data-testid="text-tiendas-fisicas">
              {data.kpisTienda.tiendasFisicas}
            </p>
          </div>
          <div className="text-center p-3 border rounded-md bg-card">
            <p className="text-xs text-muted-foreground mb-1">{t.app.analytics.kpis.physicalNetSales}</p>
          ...
          <div className="text-center p-3 border rounded-md bg-card">
            <p className="text-xs text-muted-foreground mb-1">{t.app.analytics.kpis.onlineStores}</p>
            <p className="text-xl font-bold font-mono" data-testid="text-tiendas-online">
              {data.kpisTienda.tiendasOnline}
            </p>
          </div>
          <div className="text-center p-3 border rounded-md bg-card">
            <p className="text-xs text-muted-foreground mb-1">{t.app.analytics.kpis.onlineNetSales}</p>
      ...
      {data.kpisRotacion ? (
        ...
        >
          <div className="text-center p-8 text-muted-foreground">
            <p className="text-sm">{t.app.analytics.messages.insufficientDataRotation}</p>
            <p className="text-xs mt-2">{t.app.analytics.messages.requiresColumn}</p>
          </div>
        </VisualizationCard>
      )}
                  ...
                  <>
                    ...
                    {meses.length <= 2 && (
                      <div className="mt-2 text-xs text-muted-foreground italic">
                        ℹ️ {t.app.analytics.messages.showing} {meses.length} {t.app.analytics.messages.monthsIncludingZero}
                      </div>
                    )}
                  </>
                );
          ...
          <ResponsiveContainer width="100%" height={500}>
            {(() => {
              ...
              const chartData = tiendas.map(tienda => {
                const rowData: Record<string, string | number> = { tienda };
